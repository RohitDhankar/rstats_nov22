...
#Sepal.Length, 
order_iris_2 <- df_iris[order(df_iris$Species , df_iris$Sepal.Width),]
#Sepal.Width, 
#
...
#
print(head(order_iris_1))
print(tail(order_iris_1))

#
print(head(order_iris_2))
print(tail(order_iris_2))
